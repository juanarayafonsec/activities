  ...
  return (
    <Box display="flex" justifyContent="space-between">
        <Box sx={{width: "60%"}}>
            ...
            <ButtonGroup sx={{ mt: 3 }}>
                <Button onClick={() => counterStore.decrement()} variant="contained" color="error">Decremet</Button>
                <Button onClick={() => counterStore.increment()} variant="contained" color="success">Incremet</Button>
                <Button onClick={() => counterStore.increment(5)} variant="contained" color="primary" >Incremet by 5</Button>
            </ButtonGroup>
      </Box>
